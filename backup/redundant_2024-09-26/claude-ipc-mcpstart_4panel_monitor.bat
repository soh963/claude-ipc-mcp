...
if exist "%WT_PATH%" (
    ...
    "%WT_PATH%" new-tab --title "IPC Monitor" --suppressApplicationTitle ^
        cmd /k "cd /d D:\claude-ipc-mcp && color 0A && cls && python tools\monitor_instance.py claude" ; ^
        split-pane -H --suppressApplicationTitle ^
        cmd /k "cd /d D:\claude-ipc-mcp && color 0B && cls && python tools\monitor_instance.py gemini" ; ^
        split-pane -V -t 0 --suppressApplicationTitle ^
        cmd /k "cd /d D:\claude-ipc-mcp && color 0C && cls && python tools\monitor_instance.py codex" ; ^
        split-pane -V -t 2 --suppressApplicationTitle ^
        cmd /k "cd /d D:\claude-ipc-mcp && color 0E && cls && python tools\monitor_instance.py lm"
