...
class IPCHealthChecker:
    ...
    def check_database_health(self) -> bool:
        ...
        try:
            ...
            if "instances" in tables:
                cursor.execute(
                    "SELECT COUNT(*) FROM instances WHERE project_id = ?", (self.project_id,)
                )
    ...
    def check_active_instances(self) -> List[Dict]:
        ...
        try:
            ...
            request = {"action": "list", "name": "health_checker", "project_id": self.project_id}
...
def main():
    ...
    parser = argparse.ArgumentParser(description="IPC Health Check and Diagnostic Tool")
