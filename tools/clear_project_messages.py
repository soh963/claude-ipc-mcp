...
def main():
    ...
    parser.add_argument(
        "--project-id",
        help="Specific project ID to clear (default: current project)"
    )
    parser.add_argument(
        "--all",
        action="store_true",
        help="Clear ALL messages from ALL projects (dangerous!)"
    )
    parser.add_argument(
        "--stats",
        action="store_true",
        help="Show message statistics instead of clearing"
    )
    parser.add_argument(
        "--confirm",
        action="store_true",
    ...
    count = clear_messages(
        project_id if not args.all else None,
